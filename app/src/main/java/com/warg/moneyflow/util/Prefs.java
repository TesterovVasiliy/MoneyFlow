package com.warg.moneyflow.util;
...
public class Prefs {
    ...
    // Provider const
    public static final String URI_AUTORYTIES = "com.warg.moneyflow.provider";
    public static final String URI_TYPE_EXPENSE = "expense";
    public static final Uri URI_EXPENSE = Uri.parse("content://" + URI_AUTORYTIES + "/" + URI_TYPE_EXPENSE);
